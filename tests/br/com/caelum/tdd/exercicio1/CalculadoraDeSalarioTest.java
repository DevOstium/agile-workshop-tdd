...
public class CalculadoraDeSalarioTest {
	...
	@Test
	public void deveRetornarImpostoQuinzeOuVintePorCento(){
		
	 Funcionario gerente = umFuncionario(GERENTE, comSalarioBase(5000.0));
	 
	 double salario = calculadora.calcula(gerente);
	 
	 Assert.assertEquals(5000.0 * 0.8, salario, 0.00001);
